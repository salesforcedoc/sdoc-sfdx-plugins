...
// get the row count
async function sdocGetSObjectRowCount(conn, objectName): Promise<any> {
  var returnValue = '-';
...
// get the share count
async function sdocGetSObjectShareCount(conn, objectName): Promise<any> {
  // get the share count
  var returnValue = '-';
...
async function sdocGetSObjectFirstCreated(conn, objectName): Promise<any> {
  var returnValue = '-';
...
async function sdocGetSObjectLastCreated(conn, objectName): Promise<any> {
  var returnValue = '-';
...
async function sdocGetSObjectLastModified(conn, objectName): Promise<any> {
  var returnValue = '-';
...
async function sdocGetSObjectList(conn): Promise<any> {
  ...
  var jsonResponse = sobjectResponse.sobjects.map(object => {
    ...
    var objectNamespace = sdocGetNamespace(object.name);
    const obj = {
...
function sdocLogOutput(cmd, fields, jsonResponse) {
...
function sdocGetNamespace(objectName) {
...
export { sdocLogOutput, sdocGetSObjectList, sdocGetNamespace, sdocGetSObjectRowCount, sdocGetSObjectShareCount, sdocGetSObjectFirstCreated, sdocGetSObjectLastCreated, sdocGetSObjectLastModified };
